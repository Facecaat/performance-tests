...
class OperationsGatewayHTTPClient(HTTPClient):
    ...
    def get_operations_api_summary(self, query: GetOperationsSummaryQuerySchema) -> Response:
        """
    ...
    def get_operation_receipt(self, operation_id: str) -> GetOperationResponseSchema:
